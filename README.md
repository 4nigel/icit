...
Built for building designers, and QA assessors working on small to medium sized construction projects — select elements by IFC class, export Psets and quantities to CSV for cost planning and compliance review, render shadow studies at up to 4K.
